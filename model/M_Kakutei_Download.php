    ...
    class M_Kakutei_Download extends Database 
    {
        ...
        public function addOptimize($data)
        {
            ...
            try {
                ...
                $query = "INSERT INTO $this->table (DownloadDate, DownloadProgramName, DownloadProgramYear, DownloadProgramVersion, UserClassification, UserSerialNumber, UserIDPartner, AdminComment, AdminCommentDate, DeleteFlag, DeleteFlagDate) ";
                $query .= "VALUES ";
                $query .= $data;
                $stmt = $this->conn->prepare($query);
                $stmt->execute();
